...
public class BookMain {
    public static void main(String[] args) {
        ...
        Book book2 = new Book("The Battle of Adwa: African Victory in the Age of Empire", 432, 2015);
        Book book3 = new Book("Plate Tectonics", 288, 1997);
        Book book4 = new Book("The Orthodox Church of Ethiopia", 320, 2020);
